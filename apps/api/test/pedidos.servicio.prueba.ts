...
describe('calcularTotales', function () {
  it('suma subtotal con precios del catalogo', function () {
    const resultado = calcularTotales([{ productoId: 1, cantidad: 2 }, { productoId: 2, cantidad: 1 }], function (id) { return id === 1 ? 14500000 : id === 2 ? 3800000 : undefined; });
  ...
  it('precio ausente aporta 0 al total', function () {
    const resultado = calcularTotales([{ productoId: 9, cantidad: 3 }], function () { return undefined; });
